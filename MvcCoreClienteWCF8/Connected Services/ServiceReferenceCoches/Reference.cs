...
namespace ServiceReferenceCoches
{
    ...
    public interface ICochesContract
    {
        ...
        System.Threading.Tasks.Task<ServiceReferenceCoches.Coche> FindCocheAsync(int idcoche);
    }
    ...
    public partial class CochesContractClient : System.ServiceModel.ClientBase<ServiceReferenceCoches.ICochesContract>, ServiceReferenceCoches.ICochesContract
    {
        ...
        public System.Threading.Tasks.Task<ServiceReferenceCoches.Coche> FindCocheAsync(int idcoche)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ICochesContract))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:50902/ServiceWCFCoches.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
